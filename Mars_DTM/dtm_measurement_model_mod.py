...
class DTM_measurement_model(object):
    ...
    def get_altimeter_reading(self, altimeter_dvec, altimeter_location, altimeter_velocity, debug=False):
        ...
        closest1 = sorted[0]
        intercept1 = intersections[closest1]
        altitude1 = np.linalg.norm(intercept1 - altimeter_location)

        closest2 = sorted[1]
        intercept2 = intersections[closest2]
        altitude2 = np.linalg.norm(intercept2 - altimeter_location)
        #print('DEBUG: ', altitude1, altitude2)
